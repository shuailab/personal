...
- **[IEEE-ASE]** **Feng<sup>1</sup>, J.**,  **Zhu<sup>1</sup>, X.**, Wang, F., **Huang, S.**, and Chen, C., "**A Learning Framework for Personalized Random Utility Maximization (RUM) Modeling of User Behavior**", *IEEE Transactions on Automation Science and Engineering*, 2021.
